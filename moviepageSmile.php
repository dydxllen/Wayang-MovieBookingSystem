...
<body>
    ...
    <div>
        <section class="movie-page">
                <div class="details">
                    <img class="movie-poster" src="img/m9.jpg" alt="SMILE">
                    <div class="description">
                        <div class="movie-title">
                            <h1>SMILE</h1>
                        </div>
                        <ul class="movie-details">
                            <li><i class='bx bxs-calendar' id="icon" ></i> Release Date: 30/09/2022</li>
                            <li>
                                <i class='bx bxs-message-dots' id="icon" ></i> 
                                Spoken Language: ENG</li>
                            <li>
                                <i class='bx bxs-time' id="icon"></i> 
                                Running time: 115 minutes</li>
                            <li>
                                <i class='bx bxs-purchase-tag' id="icon">
                                </i> Genre: Horror</li>
                        </ul>
                            <p><strong>Ditributor</strong><br>
                            Paramount Pictures</p> <br>
                            <p><strong>Cast</strong><br>Sosie Bacon, Jessie T. Usher, Kyle Gallner, Kal Penn, Rob Morgan</p> <br>
                            <p><strong>Synopsis</strong><br>After witnessing a bizarre, traumatic incident involving a patient, Dr. Rose Cotter starts experiencing frightening occurrences that she can't explain. As an overwhelming terror begins taking over her life, Rose must confront her troubling past in order to survive and escape her horrifying new reality. <br></p>
                            <br>
