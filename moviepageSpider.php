...
<body>
    ...
    <div>
        <section class="movie-page">
                <div class="details">
                    <img class="movie-poster" src="img/m6.jpg" alt="Avatar">
                    <div class="description">
                        <div class="movie-title">
                            <h1>Spider-Man: Far from Home</h1>
                        </div>
                        <ul class="movie-details">
                            <li><i class='bx bxs-calendar' id="icon" ></i> Release Date: 02/07/2019</li>
                            <li>
                                <i class='bx bxs-message-dots' id="icon" ></i> 
                                Spoken Language: ENG</li>
                            <li>
                                <i class='bx bxs-time' id="icon"></i> 
                                Running time: 129 minutes</li>
                            <li>
                                <i class='bx bxs-purchase-tag' id="icon">
                                </i> Genre: Action</li>
                        </ul>
                            <p><strong>Ditributor</strong><br> Sony Pictures</p> <br>
                            <p><strong>Cast</strong><br>Tom Holland, Samuel L. Jackson, Zendaya, Cobie Smulders, Jon Favreau</p> <br>
                            <p><strong>Synopsis</strong><br>Peter Parker, the beloved superhero Spider-Man, faces four destructive elemental monsters while on holiday in Europe. Soon, he receives help from Mysterio, a fellow hero with mysterious origins.<br></p>
                            <br>
